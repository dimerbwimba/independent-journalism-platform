    ...
    try {
        ...
        return {
            ...
            openGraph: {
                type: "website",
                locale: "en_US",
                url: `${process.env.NEXT_PUBLIC_APP_URL}/travel-accomodation/${country}/resort/${name}`,
            ...
            alternates: {
                canonical: `${process.env.NEXT_PUBLIC_APP_URL}/travel-accomodation/${country}/resort/${name}`,
            },
            robots: {
                index: true,
                follow: true,
            ...
            <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-[1400px] mx-auto lg:px-60 md:px-20 px-10 py-16">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {data.all_inclusive_resorts
                                    ...
                                    .map((similarResort: Resort, idx: number) => (
                                        <Link
                                            key={idx}
                                            href={`/travel-accomodation/${country}/resort/${similarResort.title
                                                .toLowerCase()
                                                .replace(/[^\w\s-]/g, '')
                                                .replace(/\s+/g, '-')
                                                .trim()}`}
                    ...
                    <div className="mt-8 mb-8 bg-white rounded-lg border border-gray-800 p-6 text-center">
                        ...
                        <Link href={`/travel-accomodation/${country}/resort/top-best`} className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            ...
                            __html: JSON.stringify({
                                ...
                                itemListElement: [
                                    ...
                                    },
                                    {
                                        ...
                                        position: 2,
                                        item: {
                                            "@id": `${process.env.NEXT_PUBLIC_APP_URL}/travel-accomodation/${country}`,
                                    ...
                                    },
                                    {
                                        ...
                                        position: 3,
                                        item: {
                                            "@id": `${process.env.NEXT_PUBLIC_APP_URL}/travel-accomodation/${country}/resort/${name}`,
                                            name: resort.title
                                        }
                                    }
                                ]
